...
void write_superblock(int fd) {
	...
	superblock.s_r_blocks_count    = 0; //NUM_BLOCKS*0.05;
	...
	superblock.s_inodes_per_group  = BLOCK_SIZE >> 3;
...
void write_block_bitmap(int fd) {
	...
	for (int i = 0; i < BLOCK_SIZE; i++)
	  block_bitmap[i] = 0;
	block_bitmap[0] = 0b11111111;
	block_bitmap[1] = 0b11111111;
	block_bitmap[2] = 0b01111111;
...
void write_inode_bitmap(int fd) {
	...
	for (int i = 0; i < BLOCK_SIZE; i++)
	  inode_bitmap[i] = 0;
	inode_bitmap[0] = 0b11111111;
	inode_bitmap[1] = 0b00011111;
...
void write_inode_table(int fd) {
	...
	const char arr[50] = "hello-world";
	memcpy(hello_inode.i_block, arr, strlen(arr)+1);
